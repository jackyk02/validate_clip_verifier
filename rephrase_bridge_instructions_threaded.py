...
sys.path.append('/root/instructions_bridge/filtered_rephrases')
...
def main():
    ...
    bridge_json_file = 'bridge_samples.json'
    ...
    output_file = f"bridge_instruction_rephrases_{timestamp}.json"
